...
?>
 <main class="container-main">
    ...
    <div class="text-second">
      ...
      <h2> Es aquella que introduce nuevas técnicas, busca innovar, quiere ser
    ...
    <div class="grid">
      ...
      <section class="recetas">
        <div class="email">
          <h1><b>COCINA CREATIVA</b></h1>
          <h1><span>¿Quieres más delicias?</h1>
          <h2>Suscríbete aquí y te enviaremos un correo electrónico cuando se publiquen nuevas recetas.</span></h2>
          <input type="text"><br>
