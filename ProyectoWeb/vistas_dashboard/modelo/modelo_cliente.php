...
class modelo_cliente
{
    ...
    public function ListaCliente()
    {
        ...
        $resSQL = $miconexion->consulta("select nombre_Usuario 'NOMBRE', apellido_Usuario 'APELLIDO',  correo_Usuario 'CORREO' from usuarios where Rol=2 order by idUsuario DESC");
