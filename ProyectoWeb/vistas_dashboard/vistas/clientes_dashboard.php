...
<head>
  ...
  <link rel="stylesheet" href="../estilos/dashboard_clientes.css">
  ...
  <div class="wrapper">
    ...
    <section class="home-section">
      <div class="home-content">
        ...
        <span class="text">Clientes</span> <br />
      </div>

      <div class="listaCliente">
        <?php
          $control = new controlador_cliente();
          $control->ListaCliente();

          if (isset($idUsuario)) {
            $control1 = new controlador_cliente();
            $control1->DeleteCliente($idUsuario);
          }
        ?>
      </div>
