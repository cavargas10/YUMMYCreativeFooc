...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="../../css/dashboard_contenido_videos.css" />
    ...
    <nav>
      ...
      <div class="sidenav">
        ...
        <div class="dropdown-container">
          ...
          <a class="active" href="contenido_videos.php"><i class="uil uil-play-circle"></i><span class="link-name">Videos</span></a>
        </div>
