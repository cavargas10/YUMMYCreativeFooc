...
<body>
    ...
    <form class="formTips" method="post" action="" enctype="multipart/form-data">
        <div id="container">
            ...
            <!-- <div id="descripcion_Tips" id="descripcion_Tips" placeholder="Ingrese el contenido" required>
            </div> -->
    ...
    <script>
        ...
        CKEDITOR.ClassicEditor.create(document.querySelector('#descripcion_Tips')),
            CKEDITOR.ClassicEditor.create(document.getElementById("descripcion_Tips"), {
